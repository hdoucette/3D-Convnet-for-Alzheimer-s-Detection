...
net = tflearn.conv_3d(net,16,1,strides=2,activation='leaky_relu', padding='VALID',weights_init='xavier',regularizer='L2',weight_decay=0.01)
#Change kernel size from 1 to 3
net = tflearn.max_pool_3d(net, kernel_size = 1, strides=2, padding='VALID')
net = tflearn.conv_3d(net, 32,1,strides=2, padding='VALID',weights_init='xavier',regularizer='L2',weight_decay=0.01)
